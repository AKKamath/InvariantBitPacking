...
void decompress_fetch(T *output, T *input, int64_t num_vecs, int64_t vec_size, 
    ...
    IndexT *index_array = nullptr, cudaStream_t stream = 0, int blks = 32, int threads = 512, int impl=0) {
    ...
    if(impl == 2) {
        ...
        const int64_t* permutation_ptr = offset_array;
